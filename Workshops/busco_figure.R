...
# Output
my_output <- paste("run_trinityBUSCO_Similis/","busco_figure.png",sep="/") 
my_width <- 20
my_height <- 15
my_unit <- "cm"
...
my_species <- c('trinityBUSCO_Similis', 'trinityBUSCO_Similis', 'trinityBUSCO_Similis', 'trinityBUSCO_Similis')
...
my_percentage <- c(30.7, 41.2, 2.2, 25.9)
my_values <- c(1627, 2182, 114, 1372)
