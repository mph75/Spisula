...
# Output
my_output <- paste("run_trinityBUSCO_Solidis/","busco_figure.png",sep="/") 
my_width <- 20
my_height <- 15
my_unit <- "cm"
...
my_species <- c('trinityBUSCO_Solidis', 'trinityBUSCO_Solidis', 'trinityBUSCO_Solidis', 'trinityBUSCO_Solidis')
...
my_percentage <- c(36.5, 40.8, 2.0, 20.7)
my_values <- c(1932, 2162, 108, 1093)
